...
namespace Catan10
{
    ...
    public class LogHeader
    {
        ...
        public GameState OldState { get; set; } = (MainPage.Current.MainPageModel.Log.PeekAction == null) ? GameState.WaitingForStart : MainPage.Current.MainPageModel.Log.PeekAction.NewState;
