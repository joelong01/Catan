...
namespace Catan10
{
    public sealed partial class StopWatchCtrl : UserControl
    {
        ...
        readonly SolidColorBrush _green = CatanColors.GetResourceBrush("Science", Colors.Green);
        readonly SolidColorBrush _red = CatanColors.GetResourceBrush("Red", Colors.Red);
        readonly SolidColorBrush _yellow = CatanColors.GetResourceBrush("Trade", Colors.Yellow);
