...
namespace Catan10
{
    public sealed partial class DeserterCtrl : UserControl
    {
        public DeserterCtrl()
        {
        ...
        public static readonly DependencyProperty StrokeThicknessProperty = DependencyProperty.Register("StrokeThickness", typeof(double), typeof(DeserterCtrl), new PropertyMetadata(30.0));
